...
module Twixo
  class Application < Rails::Application
    ...
    # Enable cookie authentication for this API application
    config.middleware.use ActionDispatch::Cookies
    config.middleware.use ActionDispatch::Session::CookieStore, key: AppConfig::Cookie::SESSION_STORE,
    tld_length: AppConfig::Config.cookie_tld_length,
    domain: :all
    config.middleware.insert_after(ActionDispatch::Cookies, ActionDispatch::Session::CookieStore, key: AppConfig::Cookie::SESSION_STORE,
    tld_length: AppConfig::Config.cookie_tld_length,
    domain: :all)
    ...
    # Configure Rails for API-only work
